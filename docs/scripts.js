 ...
 */
let _gsScope = 'undefined' !== typeof module && module.exports && 'undefined' !== typeof global ? global : this || window;
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  function R(e) {
    ...
    for (r = 0; r < y; r++)
      if (
        ...
        (g = _),
          (p = C),
          ('C' !== u && 'S' !== u) || ((g += _ - s[s.length - 4]), (p += C - s[s.length - 3])),
          h || (_ = C = 0),
        ...
        'Z' === a && ((n = l), (i = f), (s.closed = !0)),
          ('L' === a || 0.5 < Math.abs(_ - n) || 0.5 < Math.abs(C - i)) && (t(_, C, n, i), 'L' === a && (r += 2)),
          (_ = n),
          (C = i);
      else if ('A' === a) {
        if (
          (c = (function (e, t, r, o, n, i, a, h, s) {
            if (e !== h || t !== s) {
              ...
              for (D = 0; D < I.length; D += 2)
                (u = I[D]), (d = I[D + 1]), (I[D] = u * j + d * V + M), (I[D + 1] = u * B + d * X + T);
    ...
    return (
      (r = s.length) < 6 ? (m.pop(), (r = 0)) : s[0] === s[r - 2] && s[1] === s[r - 1] && (s.closed = !0),
      (m.totalPoints = S + r),
      m;
    );
  }
  ...
  function O(e, t) {
    for (var r, o, n = '', i = e.length, a = Math.pow(10, t || 2), h = 0; h < e.length; h++) {
      for (
        i = (o = e[h]).length, n += 'M' + ((o[0] * a) | 0) / a + ' ' + ((o[1] * a) | 0) / a + ' C', r = 2;
        r < i;
        r++
      )
        n += ((o[r] * a) | 0) / a + ' ';
  ...
  function M(e) {
    for (var t, r, o = e.length, n = e[0], i = n, a = e[1], h = a, s = 6; s < o; s += 6)
      n < (t = e[s]) ? (n = t) : t < i && (i = t), a < (r = e[s + 1]) ? (a = r) : r < h && (h = r);
  ...
  function z(e, t, r, o, n) {
    var i,
      ...
      g = l - 2;
    for (r *= 6, a = 0; a < l; a += 6)
      (s = e[(i = (a + r) % g)] - (t[a] - o)), (h = e[1 + i] - (t[a + 1] - n)), (f += W(h * h + s * s));
    return f;
  }
  function G(e, t, r, o, n) {
    ...
    if (u[0]) {
      ...
      if (p)
        for (
          p < 0 && (p = -p), c[0].length > u[0].length && x(u[0], ((c[0].length - u[0].length) / 6) | 0), C = u.length;
          d < p;
    ...
    for (
      ...
      if (((a += g), (n = parseFloat(e[p + 2])), (i = parseFloat(e[p + 3])), 0.999999 < a))
        for (o = 1 / (Math.floor(a) + 1), r = 1; 0.999999 < a;)
          (l += (h + (n - h) * o * r).toFixed(2) + ',' + (s + (i - s) * o * r).toFixed(2) + ' '), a--, r++;
      (l += n + ',' + i + ' '), (h = n), (s = i);
    }
    return l;
  }
            ...
            (e[1] = (function (e, t) {
              ...
              for (
                var r,
                  ...
                  n = o.length,
                  i = '',
                  a = 'reverse' === t ? ((r = n - 1), -2) : ((r = (2 * (parseInt(t, 10) || 0) + 1 + 100 * n) % n), 2),
                  h = 0;
                h < n;
                h += 2
              )
          ...
          : 'circle' === b || 'ellipse' === b
            ...
            : 'line' === b
              ...
              : ('polyline' !== b && 'polygon' !== b) ||
                ((r =
                  'M' +
                  (o = (f = (e.getAttribute('points') + '').match(X) || []).shift()) +
                  ',' +
                  (n = f.shift()) +
                  ' L' +
                  f.join(',')),
    ...
    for (var r, o, n, i, a, h, s, l, f, g, p, c, u = e.length, d = 0.2 * (t || 1); -1 < --u;) {
      for (
        ...
        (n = o[s] - o[s - 2]),
          ...
          (g = y(h, a)),
          (r = Math.abs(f - g) < d) &&
            ((c[s - 2] = f), (c[s + 2] = g), (c[s - 1] = W(n * n + i * i)), (c[s + 3] = W(a * a + h * h))),
          p.push(r, r, 0, 0, r, r);
      o[l] === o[0] &&
        o[1 + l] === o[1] &&
        ((n = o[0] - o[l - 2]),
  ...
  function j(e) {
    ...
    return {
      x:
        (0 <= e.indexOf('left') ? 0 : 0 <= e.indexOf('right') ? 100 : isNaN(parseFloat(t[0])) ? 50 : parseFloat(t[0])) /
        100,
      y:
        (0 <= e.indexOf('top') ? 0 : 0 <= e.indexOf('bottom') ? 100 : isNaN(parseFloat(t[1])) ? 50 : parseFloat(t[1])) /
        100,
    };
  }
  var B,
    ...
    re = _gsScope._gsDefine.plugin({
      ...
      init: function (e, t, r, o) {
        ...
        if (('function' == typeof t && (t = t(o, e)), !$))
          return true;
        if (
          ((s = 'POLYLINE' === (n = (e.nodeName + '').toUpperCase()) || 'POLYGON' === n), 'PATH' !== n && !s && !t.prop)
        )
        ...
        if (
          ...
          {return !1;}
        if (((h = F(t.shape || t.d || t.points || '', 'd' == i, e)), s && D.test(h)))
        ...
        if (
          ...
          if (
            ...
            if (((c = R(S ? t.precompile[0] : c)), (u = R(S ? t.precompile[1] : h)), !S && !G(c, u, l, f, P)))
              return !1;
            for (
              ...
              for (
                C = c[m], y = u[m], g = C.isSmooth || [], p = y.isSmooth || [], _ = C.length, d = B = 0;
                d < _;
                d += 2
              )
                (y[d] === C[d] && y[d + 1] === C[d + 1]) ||
        ...
        if ((this._super.setRatio.call(this, e), 1 === e && this._apply))
          ...
          if (((C._gsRawPath = u), this._apply)) {
            for (t = '', s = 0; s < u.length; s++)
              for (
                i = (n = u[s]).length, t += 'M' + ((n[0] * _) | 0) / _ + ' ' + ((n[1] * _) | 0) / _ + ' C', h = 2;
                h < i;
                h++
              )
                t += ((n[h] * _) | 0) / _ + ' ';
  ...
  (re.prototype._tweenRotation = function (e, t, r, o) {
    ...
    (re.pathFilter = function (e, t, r, o, n) {
      ...
      G(i, a, t || 0 === t ? t : 'auto', r, n) &&
        ((e[0] = O(i)), (e[1] = O(a)), ('log' !== o && !0 !== o) || A('precompile:["' + e[0] + '","' + e[1] + '"]'));
    }),
    (re.pointsFilter = r),
    (re.getTotalSize = L),
    ...
    (re.convertToPath = function (e, t) {
      ...
      for (
        var r = e && 0 !== e.length ? (e.length && e[0] && e[0].nodeType ? Array.prototype.slice.call(e, 0) : [e]) : [],
          o = r.length;
        -1 < --o;
    ...
    (re.pathDataToBezier = function (e, t) {
      ...
      if (
        ('relative' === s || !0 === s
          ...
          : ((f += l[4]),
            (g += l[5]),
            (s = s && ('string' == typeof s ? p.selector(s) : s && s[0] ? s : [s])) &&
              s[0] &&
              ((f -= (i = s[0].getBBox() || {
                x: 0,
                y: 0,
